...
`;
  ...
  class PlotpolishPanel extends HTMLElement {
    ...
    build() {
      ...
      pillGrip.addEventListener("pointercancel", (e) => this.onPillGripPointerUp(e));
      ...
      header.addEventListener("pointercancel", (e) => this.onHeaderPointerUp(e));
    ...
    updateControl(view) {
      ...
      switch (spec.type) {
        ...
        case "bool":
          view.inputs[0].checked = Boolean(value);
          break;
        case "number": {
