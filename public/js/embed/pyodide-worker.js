(function(root) {
  ...
  if (typeof self !== 'undefined' && typeof self.postMessage === 'function' &&
    ...
    var MPL_SETUP = [
      ...
      "        # Echoed so the page can tell the panel's save from the toolbar's.",
      "        _rid = _evt.get('request_id')",
      '        try:',
      '            _sbuf = _io.BytesIO()',
      ...
      "            _trinket_mpl_send(figid, 'save-error', _json.dumps(",
      "                {'error': str(_err), 'request_id': _rid}))",
      '        return',
      '    _m.handle_json(_evt)',
